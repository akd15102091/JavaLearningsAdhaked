...
public class ParallelFileCopy {
    ...
    private static final int CHUNK_SIZE = 100 * 1024 * 1024; // 100MB chunks
    ...
    static class FileCopyTask extends RecursiveTask<Long> {
        ...
        public FileCopyTask(File sourceFile, File destFile, long start, long end) {
        ...
        private long copyChunk() {
            try (RandomAccessFile source = new RandomAccessFile(sourceFile, "r");
                ...
                return sourceChannel.transferTo(start, bytesToCopy, destChannel);
            } catch (IOException e) {
                e.printStackTrace();
                return 0;
            }
